...
class Newsmag_Lite {
	...
	public function enqueues() {
		...
		wp_enqueue_style( 'newsmag-stylesheet', get_template_directory_uri() . '/assets/css/style-min.css', array(), $newsmag['Version'] );
		...
		/**
		 * Personalizados de Adiel
		 */
		//wp_enqueue_script( 'jquery', get_template_directory_uri() . '/assets/vendors/jquery/js/jquery-3.2.1.min.js'); /* Ultima version de Jquery */
		//wp_enqueue_script( 'jquery-ui', get_template_directory_uri() . '/assets/vendors/jquery/js/ui/jquery-ui.min.js'); /* Ultima version del plugin de jquery Autocomplete*/	
		//wp_enqueue_script( 'jqueryy-ui', get_bloginfo('url') . '/wp-includes/js/jquery/ui/autocomplete.min.js');
		wp_enqueue_style( 'font-awesomee', get_template_directory_uri() . '/assets/css/font-awesome.min.css');
				
		
		/**
		 * Plugin Fresco Adiel
		 */
		//wp_enqueue_script( 'fresco', get_template_directory_uri() . '/assets/vendors/fresco/fresco.js', array(), $newsmag['Version'], true );
		//wp_enqueue_style( 'fresco', get_template_directory_uri() . '/assets/vendors/fresco/fresco.css' );
		
		/**
		 * Plugin FlexSlider 2 Adiel
		 */
		//wp_enqueue_script( 'flexslider', get_template_directory_uri() . '/assets/vendors/flexslider/jquery.flexslider-min.js', array(), $newsmag['Version'], true );
		//wp_enqueue_style( 'flexslider', get_template_directory_uri() . '/assets/vendors/flexslider/flexslider.css' );
	...
	public function theme_setup() {
		...
		add_image_size( 'newsmag-background-header', 1663, 200, true );
		add_image_size( 'newsmag-slider-flexslider', 818, 540, true );
		add_image_size( 'newsmag-carousel-flexslider', 120, 67, true );
